  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm bg-body-tertiary sticky-top">
      ...
      <a class="navbar-brand" href="#">
          <img src="img/gambar udinus.png" alt="logo Imge" width="50" height="50" class="me-2">
           UDINUS
        </a>
        <button
      ...
      ?>
        <div class="col">
          <div class="card h-100">
            <img src="img/<?= $row["gambar"]?>" class="card-img-top"  style="width:300px;height:300px" walt="..." />
            <div class="card-body">
...
<!-- article end -->
    ...
    <section id="gallery" class="text-center p-5 bg-primary-subtle">
      <div class="container">
        ...
        <div class="carousel-indicators">
          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" class="active caroousel-light" aria-current="true" aria-label="Slide 1"></button>
          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" class="carousel-light" aria-label="Slide 2"></button>
          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" class="carousel-light" aria-label="Slide 3"></button>
        </div>
    ...
    <footer id="footer" class="text-center p-5  ">
      <div>
        <a href="https://www.instagram.com/rafiakbarhakim?igsh=dm9oYnI0NmplanVp"
          ><i class="bi bi-instagram h2 p-2"></i
        ></a>
        <a href="https://www.tiktok.com/@robi17457?_t=8qyaEH2Bobi&_r=1"
          ><i class="bi bi-tiktok h2 p-2"></i
        ></a>
        <a href="https://wa.me/+628974517733"
          ><i class="bi bi-whatsapp h2 p-2"></i
        ></a>
      </div>
      <div>Muhammad Rafi Akbar Hakim &copy; 2024</div>
    </footer>
    <!-- footer end -->
    <script
